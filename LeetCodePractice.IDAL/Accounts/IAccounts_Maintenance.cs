...
namespace GISWaterSupplyAndSewageServer.IDAL.Accounts
{
    ...
    /// 养护台账
    /// </summary> 
    public interface IAccounts_Maintenance : IDependency
    {
        ...
        MessageEntity Add(Gis_Accounts_Maintenance model);
        MessageEntity Update(Gis_Accounts_Maintenance model);
        MessageEntity Delete(Gis_Accounts_Maintenance model);
