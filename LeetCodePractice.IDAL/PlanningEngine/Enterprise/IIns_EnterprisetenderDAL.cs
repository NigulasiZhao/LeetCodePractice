...
namespace GISWaterSupplyAndSewageServer.Model.PlanningEngine.Enterprise
{
    ...
    ///企业投标信息DAL层
    /// </summary>
    public interface IIns_EnterprisetenderDAL : IDependency
    {
        /// <summary>
        /// 添加企业投标信息
        /// </summary>
        ...
        /// <returns></returns>
        MessageEntity Add(Ins_Enterprisetender model);
        /// <summary>
        ///修改企业投标信息
        /// </summary>
        /// <param name="model">模型</param>
        /// <returns></returns>
        MessageEntity Update(Ins_Enterprisetender model);
        /// <summary>
        /// 删除企业投标信息
        /// </summary>
        /// <param name="model">模型</param>
        /// <returns></returns>
        MessageEntity Delete(Ins_Enterprisetender model);
        /// <summary>
        /// 根据ID获取企业投标信息
        /// </summary>
        /// <param name="ID"></param>
        /// <returns></returns>
        Ins_Enterprisetender GetInfo(string ID);
        /// <summary>
        /// 获得企业投标信息列表
        /// </summary>
