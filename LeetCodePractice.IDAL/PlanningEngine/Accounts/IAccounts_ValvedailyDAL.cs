...
namespace GISWaterSupplyAndSewageServer.Model.PlanningEngine
{
    ...
    ///阀门日常巡查记录表DAL层
    /// </summary>
    public interface IAccounts_ValvedailyDAL : IDependency
    {
        /// <summary>
        /// 添加阀门日常巡查记录表
        /// </summary>
        ...
        /// <returns></returns>
        MessageEntity Add(Accounts_Valvedaily model);
        /// <summary>
        ///修改阀门日常巡查记录表
        /// </summary>
        /// <param name="model">模型</param>
        /// <returns></returns>
        MessageEntity Update(Accounts_Valvedaily model);
        /// <summary>
        /// 删除阀门日常巡查记录表
        /// </summary>
        /// <param name="model">模型</param>
        /// <returns></returns>
        MessageEntity Delete(Accounts_Valvedaily model);
        /// <summary>
        /// 根据ID获取阀门日常巡查记录表
        /// </summary>
        /// <param name="ID"></param>
        /// <returns></returns>
        Accounts_Valvedaily GetInfo(string ID);
        /// <summary>
        /// 获得阀门日常巡查记录表列表
        /// </summary>
