...
namespace GISWaterSupplyAndSewageServer.Model.PlanningEngine
{
    ...
    ///消火栓日常巡查记录表DAL层
    /// </summary>
    public interface IAccounts_FirehydrantdailyDAL : IDependency
    {
        /// <summary>
        /// 添加消火栓日常巡查记录表
        /// </summary>
        ...
        /// <returns></returns>
        MessageEntity Add(Accounts_Firehydrantdaily model);
        /// <summary>
        ///修改消火栓日常巡查记录表
        /// </summary>
        /// <param name="model">模型</param>
        /// <returns></returns>
        MessageEntity Update(Accounts_Firehydrantdaily model);
        /// <summary>
        /// 删除消火栓日常巡查记录表
        /// </summary>
        /// <param name="model">模型</param>
        /// <returns></returns>
        MessageEntity Delete(Accounts_Firehydrantdaily model);
        /// <summary>
        /// 根据ID获取消火栓日常巡查记录表
        /// </summary>
        /// <param name="ID"></param>
        /// <returns></returns>
        Accounts_Firehydrantdaily GetInfo(string ID);
        /// <summary>
        /// 获得消火栓日常巡查记录表列表
        /// </summary>
