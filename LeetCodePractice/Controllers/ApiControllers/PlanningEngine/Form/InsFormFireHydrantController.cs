...
namespace GISWaterSupplyAndSewageServer.Controllers.ApiControllers.PlanningEngine.Form
{
    ...
    /// 消防栓填单(APP)
    /// </summary>
    public class InsFormFireHydrantController : BaseController
    {
        private readonly IIns_FormDAL _iIns_Form_FireHydrantDAL;
        ...
        public InsFormFireHydrantController(IIns_FormDAL iIns_Form_FireHydrantDAL, IIns_TaskManageDAL iIns_TaskManageDAL
            /*, IIns_EventDAL eventManage, IIns_Event_TypeDAL ins_Event_TypeDAL*/)
        {
            _iIns_Form_FireHydrantDAL = iIns_Form_FireHydrantDAL;
        ...
        /// <summary>
        /// 消防栓填单 APP调用：(Headers传递app和token) 
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public MessageEntity Post(string ID, string x, string y, [FromBody] Ins_Form_FireHydrantModel value, int? isReport = null, string? eventTypeId = null, string? eventTypeId2 = null, string? eventDesc = null, string? rangName = null, string? execDetpID = null, string? execDetpName = null, string? execPersonId = null, string? execPersonName = null)
        {
            if (value == null)
            {
            ...
            MessageEntity result = _iIns_Form_FireHydrantDAL.PostFireHydrant(value, taskdetailmode, ImagePath, x, y, iadminid, iadminame);
