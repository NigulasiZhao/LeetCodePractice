...
namespace GISWaterSupplyAndSewageServer.Controllers.ApiControllers.PlanningEngine.Form
{
 ...
 ///共用管道及附属设备填单
 /// </summary>
 public class InsFormPipelineequController:BaseController
{
        ...
        public InsFormPipelineequController(IIns_FormDAL iIns_FormDAL, IIns_TaskManageDAL iIns_TaskManageDAL
        ...
        [HttpPost]
        public MessageEntity Post(string ID, string x, string y, [FromBody] Ins_Form_PipelineequModel value, string? imageUrl = null)
        {
            if (value == null)
            {
            ...
            MessageEntity result = _iIns_FormDAL.PostPipelineequ(value, taskdetailmode, ImagePath, x, y, iadminid, iadminame, upDeptId, upDeptName);
            //调用判断任务对应的所有设备是否到位
